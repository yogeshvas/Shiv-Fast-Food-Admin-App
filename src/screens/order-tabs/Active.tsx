  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get(
        'https://shiv-phi.vercel.app/api/orders/pending',
      );
          ...
          <View style={styles.expandedContent}>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.sectionContent}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    Linking.openURL(`tel:+91${item.customePhone}`)
                  }>
                  <Text style={{fontFamily: 'Space-Medium', color: '#0779F5'}}>
            ...
            <TouchableOpacity
              ...
              {isAccepting ? (
                ...
                <Text style={styles.deliverButtonText}>Accept Order</Text>
              )}
            </TouchableOpacity>
          </View>
        )}
